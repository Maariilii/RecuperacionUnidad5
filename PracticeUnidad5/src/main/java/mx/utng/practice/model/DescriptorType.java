...
public class DescriptorType {
	...
	private Long id;
	@Column 
	private int descriptorTypeCode;
	@Column(length=50)
	...
	public DescriptorType(int descriptorTypeCode, String descriptorTypeName, String descriptorTypeUnit,
	...
	public int getDescriptorTypeCode() {
		return descriptorTypeCode;
	}
	public void setDescriptorTypeCode(int descriptorTypeCode) {
		this.descriptorTypeCode = descriptorTypeCode;
	}
	...
	public String toString() {
		return "DescriptorType [id=" + id + ", descriptorTypeName=" + descriptorTypeName + ", descriptorTypeUnit="
				+ descriptorTypeUnit + ", descriptorTypeDesc=" + descriptorTypeDesc + ", descriptorTypeLength="
